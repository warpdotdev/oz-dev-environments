...
[Oz environments](https://docs.warp.dev/platform/environments). These images provide ready-to-use
development environments for running [Oz agents](https://docs.warp.dev/ambient-agents/ambient-agents-overview)
and [Oz integrations](https://docs.warp.dev/platform/agent-api-and-sdk).

## Quickstart

To get started, you'll need to have the [Oz CLI](https://docs.warp.dev/developers/cli) installed and
...
- [Oz Platform Overview](https://docs.warp.dev/platform/warp-platform)
- [Oz Environments](https://docs.warp.dev/platform/environments)
- [Oz Agents](https://docs.warp.dev/ambient-agents/ambient-agents-overview)
